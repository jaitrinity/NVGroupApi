...
$approverSql = "SELECT mp.ActivityId,mp.MenuId,mp.LocationId,concat(l.Site_Type,' - ',l.Name) as Name,l.Site_Id,l.GeoCoordinates,m.Verifier,m.Approver,mp.Start,mp.End,
